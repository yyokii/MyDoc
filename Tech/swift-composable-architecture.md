...
また、機能のアクションを表す型を定義する必要があります。デクリメントボタン、インクリメントボタン、豆知識ボタンをタップするなど、明確はアクションがあります。しかし、アラートを却下するユーザーのアクションや、豆知識取得APIリクエストから応答を受け取ったときに発生するアクションなど、少し明白ではないものもあります。
